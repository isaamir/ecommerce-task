...
const Input = (props:any) => {
  ...
  const styles = {
    base: 'text-[#4B4B4B] font-normal border-solid border-[1px]  flex-1 appearance-none w-full py-2 px-4  text-gray-700  shadow-sm text-base focus:outline-none focus:ring-1 focus:border-transparent',
    state: {
